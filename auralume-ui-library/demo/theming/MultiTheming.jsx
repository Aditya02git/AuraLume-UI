...
const MultiTheming = ({isDarkMode, setIsDarkMode}) => {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Get started instantly with our curated collection of pre-built themes. Simply wrap your application with the ThemeProvider in your{' '}
            <code style={{
              padding: '4px 10px',
              fontSize: '16px',
            ...
            file to unlock all available themes.
          </p>
...
export default App;`}</CodeBlock>
          ...
          <p style={{
            ...
            component to give your users the power to switch between all available themes with a sleek dropdown selector.
          </p>

          <div style={{ marginBottom: '56px' }}>
            <CodeBlock language='jsx'>
              {`
import { themes, useTheme } from "@aditya030/aura-lume1";
import React, { useEffect, useState } from "react";
...
const ThemeSwitcher = () => {
  ...
  const options = Object.keys(themes).map((key) => ({
    value: key,
...
`}</CodeBlock>
          ...
          <p style={{
            ...
            Experience the power of dynamic theming with this interactive example. Implement this code in your{' '}
            <code style={{
              padding: '4px 10px',
              fontSize: '16px',
              fontFamily: 'ui-monospace, monospace',
            ...
            to witness real-time theme transformations across all your components.
          </p>
