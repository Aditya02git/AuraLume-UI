...
import WindEffect from "../../src/components/ThreeJs/WindEffect";
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        const distance = 0.8 * Math.max(fitHeightDistance, fitWidthDistance);
        
        camera.position.copy(center);
        camera.position.z = distance;
        camera.position.x = 1.8 * Math.max(fitHeightDistance, fitWidthDistance);
...
// Main Component
const WindEffectSection = ({isDarkMode, setIsDarkMode}) => {
...
const App = () => {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', margin: 0, padding: 0 }}>
      ...
      {/* WindEffect (rendered once scene ready) */}
      {sceneReady && (
        <WindEffect
          ref={effectRef}
          speed = {1}
...
`;
  ...
  const propsTableData = [
          { prop: "speed", type: "number", default: "1", desc: "Speed multiplier for wind animation" },
          { prop: "animation", type: "boolean", default: "true", desc: "Whether the wind effect is animated" },
          { prop: "intensity", type: "number", default: "6", desc: "Number of wind ribbons to render" },
          { prop: "position", type: "object", default: "{ x: 0, y: 0, z: 0 }", desc: "Position of the wind effect in 3D space" },
          { prop: "rotation", type: "object", default: "{ x: 0, y: 0, z: 0 }", desc: "Rotation of the wind effect in 3D space" },
          { prop: "color", type: "number", default: "0xffffff", desc: "Color of the wind ribbons (default white)" },
          { prop: "spiralRadius", type: "number", default: "8", desc: "Radius or size of the wind spiral" },
          { prop: "ribbonWidth", type: "number", default: "0.1", desc: "Width of each wind ribbon" },
          { prop: "mode", type: "string", default: "'flow'", desc: "Wind mode: 'flow' for directional or 'whirl' for spiral motion" },
          { prop: "area", type: "array", default: "[40, 40]", desc: "Area covered by the wind effect in flow mode [width, depth]" },
          { prop: "windAmount", type: "number", default: "2", desc: "Controls the length or density of wind (0.5 to 2 recommended)" },
          { prop: "windCurls", type: "number", default: "2", desc: "Controls the curviness or turbulence of wind paths" },
          { prop: "onGroupCreated", type: "function | null", default: "null", desc: "Callback invoked when the Three.js group is created" },
          { prop: "ref", type: "React.Ref", default: "-", desc: "Forwarded ref to access the internal group object" },
        ];
  ...
  return (
    <div>
      ...
      <PreviewSection
        title=""
        modelPath="https://cdn.jsdelivr.net/gh/Aditya02git/3d-models-cdn/wind_mill.glb"
        effectProps={{
        //   type: "smoke",
        //   speed: 1.5,
        //   animation: true,
        //   size: 1,
        //   position: {x: 1.2, y: 3.5, z: -4.5}
        }}
...
export default WindEffectSection;