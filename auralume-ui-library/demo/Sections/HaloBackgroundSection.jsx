...
const HaloBackgroundSectionWithPreview = ({ title, children, jsxCode, isDarkMode }) => {
...
const HaloBackgroundSection = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    <div>
      ...
      <div>
        <HaloBackgroundSectionWithPreview title="" jsxCode={basicSpotlightJSX} isDarkMode={isDarkMode}>
