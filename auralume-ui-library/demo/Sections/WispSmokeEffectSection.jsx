...
import WispSmokeEffect from "../../src/components/ThreeJs/WispSmokeEffect";
...
// Main Component
const WispSmokeEffectSection = ({isDarkMode, setIsDarkMode}) => {
...
const App = () => {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', margin: 0, padding: 0 }}>
      ...
      {/* WispSmokeEffect (rendered once scene ready) */}
      {sceneReady && (
        <WispSmokeEffect
          ref={effectRef}
          position={{ x: 0, y: 1, z: 0 }}
          onGroupCreated={handleEffectGroupCreated}
          key={\`wisp-smoke-effect-\${sceneReady}\`}
        />
      )}
    </div>
  );
...
`;
  ...
  const propsTableData = [
          { prop: "speed", type: "number", default: "0.5", desc: "Controls how fast the smoke wisps move or animate." },
          { prop: "animation", type: "boolean", default: "true", desc: "Enables or disables the smoke animation." },
          { prop: "size", type: "number", default: "50", desc: "Defines the overall size or radius of the smoke effect." },
          { prop: "spreadArea", type: "number", default: "1.0", desc: "Controls how widely the smoke spreads out in space." },
          { prop: "position", type: "object", default: "{ x: 0, y: 0, z: 0 }", desc: "Sets the 3D position of the smoke in the scene." },
          { prop: "rotation", type: "object", default: "{ x: 0, y: Math.PI / 5, z: 0 }", desc: "Defines the rotation of the smoke system." },
          { prop: "color", type: "array<string>", default: '["#ffffff"]', desc: "Defines smoke color(s); multiple values create variation." },
          { prop: "perlinTexturePath", type: "string", default: '"https://cdn.jsdelivr.net/gh/Aditya02git/perlin-noise-texture@main/noiseTexture.png"', desc: "URL of the Perlin noise texture used for smoke motion." },
  ...
  return (
    <div>
      ...
      <PreviewSection
        title=""
        modelPath="https://cdn.jsdelivr.net/gh/Aditya02git/3d-models-cdn/tower.glb"
        effectProps={{
          position: {x: -0.75, y: 7.5, z: -1.85}
        }}
...
export default WispSmokeEffectSection;