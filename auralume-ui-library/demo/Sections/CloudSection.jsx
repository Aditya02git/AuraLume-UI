...
import Cloud from "../../src/components/ThreeJs/Cloud/Cloud";

// Canvas Component with 3D Model Loading and Integrated Cloud Effects
const ThreeCanvas = ({ modelPath, effectType, effectProps, canvasId }) => {
  ...
  useEffect(() => {
    ...
    const pointLight1 = new THREE.PointLight(0x7658ef, 0.4, 100);
    pointLight1.position.set(-10, 10, 10);
    scene.add(pointLight1);

    const pointLight2 = new THREE.PointLight(0xfca4c5, 0.4, 100);
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', minHeight: '400px' }}>
      ...
      {/* Cloud Component - now integrated into the scene */}
      ...
      >
        ...
        <div style={{ 
          ...
          <ThreeCanvas
            ...
            canvasId={`canvas-${title ? title.replace(/\s+/g, '-').toLowerCase() : 'cloud'}`}
          />
        </div>
      </div>
    </section>
...
// Main Component
const CloudSection = ({isDarkMode, setIsDarkMode}) => {
...
const App = () => {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', margin: 0, padding: 0 }}>
      ...
      {/* Cloud component - only render when scene is ready */}
      {sceneReady && sceneRef.current && (
        <Cloud 
          ref={effectRef} 
          speed={1.5} 
...
export default App;`;
  ...
  const propsTableData = [
    { prop: "areaSize", type: "array", default: "[50, 8, 50]", desc: "Dimensions of the cloud spawning area [x, y, z]" },
    { prop: "areaCenter", type: "array", default: "[0, 15, 0]", desc: "Center position of the cloud spawning area" },
    { prop: "windDirection", type: "string", default: "east", desc: "Direction of wind movement (north, south, east, west)" },
    { prop: "windSpeed", type: "number", default: "0.1", desc: "Speed of cloud drift across the sky" },
    { prop: "cloudDensity", type: "number", default: "0.3", desc: "Probability of cloud spawn density (0 → none, 1 → full)" },
    { prop: "spawnRate", type: "number", default: "5.0", desc: "How frequently new clouds are spawned (per second)" },
    { prop: "cloudLifetime", type: "number", default: "120.0", desc: "Lifetime of each cloud before it fades out" },
    { prop: "cloudCount", type: "number", default: "15", desc: "Maximum number of clouds rendered at once" },
    { prop: "cloudScale", type: "array", default: "[1, 1, 1]", desc: "Scale of the entire cloud system [x, y, z]" },
    { prop: "cloudPosition", type: "array", default: "[0, 0, 0]", desc: "Position offset for the entire cloud group" },
    { prop: "animationSpeed", type: "number", default: "1", desc: "Speed multiplier for cloud shader animations" },
    { prop: "cloudTypeDistribution", type: "object", default: "{ cirrus: 0, cumulus: 0.35, stratus: 0, nimbus: 0 }", desc: "Distribution ratio of different cloud types (must sum to 1.0)" },
    { prop: "cloudColor", type: "color/null", default: "null", desc: "Override base cloud color" },
    { prop: "shadowColor", type: "color/null", default: "null", desc: "Override shadow color of clouds" },
    { prop: "opacity", type: "number/null", default: "null", desc: "Override per-cloud opacity" },
    { prop: "fluffiness", type: "number/null", default: "null", desc: "Override per-cloud fluffiness (noise distortion strength)" },
    { prop: "density", type: "number/null", default: "null", desc: "Override per-cloud density (internal scatter amount)" },
    { prop: "cloudSize", type: "array", default: "[2, 1.5, 2]", desc: "Base size of individual cloud instances [x, y, z]" },
  ];
