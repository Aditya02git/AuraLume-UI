...
import CardScape from '../../src/components/Cardscape';
...
const CardScapeSectionWithPreview = ({ title, children, jsxCode, isDarkMode }) => {
...
const CardScapeSection = ({isDarkMode, setIsDarkMode}) => {
  ...
  const customCardScapeJSX = `
    ...
    <div>
      <CardScape 
        ...
        className= {isDarkMode ? 'cardscape-dark' : 'cardscape-light'}
...
>
  <div style={{ overflowX: "auto" }}>
    ...
    >
      ...
      <tbody>
        {[
          { prop: "cards", type: "array", default: "[]", desc: "Array of card data objects to render inside the CardScape layout." },
          { prop: "className", type: "string", default: "''", desc: "Custom CSS class for additional styling of the CardScape container." },
          { prop: "containerMaxWidth", type: "string", default: "'1200px'", desc: "Maximum width of the card container. Accepts CSS size values (e.g., '100%', '1200px')." },
          { prop: "gap", type: "string", default: "'20px'", desc: "Defines the spacing between individual cards in the layout." },
          { prop: "minCardWidth", type: "string", default: "'300px'", desc: "Sets the minimum width each card can shrink to before wrapping to a new row." },
        ].map((row, index) => (
          <tr
            key={index}
            style={{
      ...
      <CardScapeSectionWithPreview
        title=""
        jsxCode={customCardScapeJSX}
      ...
      > 
        ...
        containerMaxWidth = "1200px"
        gap = "20px"
        minCardWidth = {isMobile ? "150px" : "300px"}
        />
      </CardScapeSectionWithPreview>
    </div>
  );
...
export default CardScapeSection;