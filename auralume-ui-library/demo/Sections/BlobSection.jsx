...
/>`;
  ...
  const basicShapesJSX = `import Blob from './Blob';
...
/>`;
  ...
  // 🎨 Basic Styling
  { prop: "color", type: "string", default: "'#ffffff'", desc: "Base color of the blob surface" },
  ...
  { prop: "animationSpeed", type: "number", default: "1", desc: "Multiplier controlling the speed of blob animation" },
  { prop: "rotationSpeed", type: "object", default: "{ x: 0.01, y: 0.005 }", desc: "Rotation speed of the blob around x and y axes" },
  { prop: "morphStrength", type: "number", default: "0.1", desc: "Controls the intensity of the blob morphing effect" },

  // 🔷 Geometry
  { prop: "detail", type: "number", default: "4", desc: "Level of geometric detail or subdivision for the blob mesh" },
  { prop: "size", type: "number", default: "1", desc: "Overall scale of the blob geometry" },

  // 🎥 Camera
  { prop: "cameraPosition", type: "object", default: "{ x: 0, y: 0, z: 8 }", desc: "Initial position of the camera in 3D space" },
  { prop: "fov", type: "number", default: "35", desc: "Field of view for the perspective camera" },
  ...
  { prop: "pointLightColor", type: "string", default: "'#f00555'", desc: "Color of the point light source" },
  { prop: "pointLightIntensity", type: "number", default: "0.5", desc: "Intensity of the point light" },
  { prop: "pointLightPosition", type: "object", default: "{ x: 0, y: 0, z: 3 }", desc: "Position of the point light source in 3D space" },

  // 🕹️ Controls
  { prop: "orbitControl", type: "boolean", default: "false", desc: "Enable orbit camera controls for user interaction" },

  // 🧱 Material
  { prop: "wireframe", type: "boolean", default: "false", desc: "Render the blob in wireframe mode" },
  { prop: "material", type: "string", default: "'normal'", desc: "Type of material used for rendering ('normal', 'basic', 'standard', 'phong')" },

  // 🧩 Events
  { prop: "onReady", type: "function", default: "null", desc: "Callback triggered when the blob scene is initialized" },
  { prop: "onClick", type: "function", default: "null", desc: "Callback triggered when the blob is clicked" },

  // 🎨 Custom Styles
  { prop: "className", type: "string", default: "''", desc: "Custom CSS class for the blob container" },
  { prop: "style", type: "object", default: "{}", desc: "Inline style overrides for the blob container" },
];
